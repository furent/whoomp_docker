export declare const PacketType: Readonly<{
    COMMAND: 35;
    COMMAND_RESPONSE: 36;
    REALTIME_DATA: 40;
    HISTORICAL_DATA: 47;
...
export declare const MetadataType: Readonly<{
    HISTORY_START: 1;
    HISTORY_END: 2;
    HISTORY_COMPLETE: 3;
}>;
export declare const EventNumber: Readonly<{
    UNDEFINED: 0;
    ERROR: 1;
    CONSOLE_OUTPUT: 2;
    BATTERY_LEVEL: 3;
...
export declare const CommandNumber: Readonly<{
    LINK_VALID: 1;
...
export declare class WhoopPacket {
    static sof: number;
    type: number;
    seq: number;
    cmd: number;
    data: Uint8Array;
    constructor(type: number, seq: number, cmd: number, data?: Uint8Array);
    /**
